...
public sealed class Umap
{
    ...
    private sealed class OptimizationState
    {
        ...
        public int[] Head                       =  [];
        public int[] Tail                       =  [];
        public float[] EpochsPerSample          =  [];
        public float[] EpochOfNextSample        =  [];
        public float[] EpochOfNextNegativeSample=  [];
        public float[] EpochsPerNegativeSample  =  [];
